...
declare module 'ZEPETO.Multiplay' {
    ...
    import * as ZEPETO_Multiplay_ZepetoMultiplayBase from 'ZEPETO.Multiplay.ZepetoMultiplayBase';
    ...
    class ZepetoMultiplayBase extends UnityEngine.MonoBehaviour {
        ...
        public static modeSelector: System.Func$1<ZEPETO_Multiplay_ZepetoMultiplayBase.MatchMakeMode>;
        ...
        public get matchMakeMode(): ZEPETO_Multiplay_ZepetoMultiplayBase.MatchMakeMode;
    ...
    type ColyseusCloseEventHandler = (code: number, roomId: string) => void;
    var ColyseusCloseEventHandler: {new (func: (code: number, roomId: string) => void): ColyseusCloseEventHandler;}
...
declare module 'ZEPETO.Multiplay.ZepetoMultiplayBase' {

        
    
    enum MatchMakeMode { Http = 0, WebSocket = 1 }
